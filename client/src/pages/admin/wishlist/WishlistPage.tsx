...
export function AdminWishlist() {
  ...
  React.useEffect(() => {
    const fetchVolunteers = async () => {
      ...
      try {
        const response = await fetch(`${import.meta.env.VITE_BASE_URL}/admin/wishlist/${user.institution._id}`, {
          method: 'GET',
          headers: {
  ...
  const handleDelete = async (volunteerId: string) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_BASE_URL}/admin/wishlist/${volunteerId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${user?.token}`,
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align='end'>
              ...
              <DropdownMenuItem>
                <Link to={`/admin/update-wishlist/${volunteer._id}`}>Edit</Link>
              </DropdownMenuItem>
  ...
  return (
    <div className='w-[90%] m-auto'>
      <h1 className='text-3xl mt-4'>WishLists</h1>
      <div className='flex justify-between items-center'>
        <h1 className='text-xl mt-4'>Wish List</h1>
        <Link to='/admin/add-wishlist'>
      ...
      <div className='flex items-center py-4'>
        <Input
          placeholder='Filter wishlist by name...'
